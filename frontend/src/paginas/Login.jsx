...
const Login = () => {
  ...
  return (
    <div className="page-container">
      <div className="hover:cursor-default corner-text fixed top-0 left-0 p-5">
        <h2 className="font-Poppins-700 opacity-90 hover:opacity-100 text-5xl duration-500 p-5
        hover:-translate-y-1 italic text-center bg-clip-text text-transparent
        bg-gradient-to-r from-[#ffffff] via-[#ffffff] to-[#504f4f]">GOT<span className="text-transparent bg-clip-text 
      ...
      <h1 className="opacity-80 hover:opacity-100 hover:scale-105 hover:translate-x-3 hover:cursor-default
        duration-1000 skew-3 bg-clip-text text-transparent hover:shadow-[#f30000]
        bg-gradient-to-br from-[#d8d8d8] via-[#dbdbdb] to-[#474747] hover:from-[#ffffff] hover:from-30% hover:via-[#ce2929] hover:to-[#df9696]
        italic font-Poppins-300 font-bold text-[2.30rem] hover:duration-1000 capitalize h-40 p-1">
      ...
      <form
        className="delay-100 font-Poppins opacity-80 custom-shadow
      ...
      >
        ...
        <button
          ...
          italic w-full py-2
          text-white uppercase delay-75 rounded-3xl text-white shadow-inner
          active:animate-ping pointer-events-auto hover:shadow-[#5e0005]  font-thin duration-1000"
        >
          Login
        </button>
      </form>
      ...
      <nav className="lg:flex lg:justify-between">
        ...
        <Link
          className="font-Poppins delay-75 opacity-90 hover:skew-x-3 hover:opacity-100 hover:scale-110 shadow-lg p-2 hover:shadow-white shadow-black-950 rounded-full block duration-500 text-center hover:-translate-y-1 my-5 text-[#ffffff] uppercase text-sm"
        ...
        <Link
          className="font-Poppins delay-75 opacity-90 hover:skew-x-3 hover:opacity-100 hover:scale-110 block duration-500 hover:-translate-y-1 text-center my-5 text-[#ffffff] shadow-lg p-2 hover:shadow-white shadow-black-950 rounded-full uppercase text-sm"
